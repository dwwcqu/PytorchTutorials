...
class TestMyMulAdd(TestCase):
    ...
    def _test_correctness(self, device):
        ...
        for args in samples:
            result = dengww.ops.mymuladd(*args)
    ...
    def _opcheck(self, device):
        ...
        for args in samples:
            opcheck(torch.ops.dengww.mymuladd.default, args)
...
class TestMyAddOut(TestCase):
    ...
    def _opcheck(self, device):
        ...
        samples.extend(self.sample_inputs(device, requires_grad=False))
        for args in samples:
            opcheck(torch.ops.dengww.myadd_out.default, args)
